...
class User
{
    ...
    public static function constructOfflinePlayerUuid($username): string
    {
    ...
    public static function createJavaUuid($striped): string
    {
    ...
    public function removeGroup(?int $group_id): bool
    {
        ...
        $this->_db->query('DELETE FROM `rw_users_groups` WHERE `user_id` = ? AND `group_id` = ?', [
            $this->data()->id,
            $group_id
        ]);
