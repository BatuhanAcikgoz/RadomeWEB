...
if (Util::getSetting('member_list_hide_banned', false, 'Members')) {
    ...
    $query = DB::getInstance()->query('SELECT id FROM rw_users ORDER BY joined DESC LIMIT 12');
}
...
$smarty->assign([
    ...
    'QUERIES_URL' => URL::build('/sorgu/member_list', 'list={{list}}&page={{page}}&overview=' . ($viewing_list === 'overview' ? 'true' : 'false')),
    ...
    'SEARCH_URL' => URL::build('/sorgu/users'),
