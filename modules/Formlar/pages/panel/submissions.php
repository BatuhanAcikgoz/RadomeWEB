 ...
 *  License: MIT
 *
 *  Formlar module - panel form page
 */
                        ...
                        // Alert user?
                            ...
                            if ($target_user->exists() && $forms->canViewOwnSubmission(implode(',', $target_user->getAllGroupIds()), $submission->data()->form_id)) {
                                ...
                                Alert::create(
                                    ...
                                    'submission_update',
                                    ['path' => ROOT_PATH . '/modules/Formlar/language', 'file' => 'forms', 'term' => 'your_submission_updated', 'replace' => ['{x}'], 'replace_with' => [Output::getClean($form->data()->title)]],
                                    ['path' => ROOT_PATH . '/modules/Formlar/language', 'file' => 'forms', 'term' => 'your_submission_updated', 'replace' => ['{x}'], 'replace_with' => [Output::getClean($form->data()->title)]],
