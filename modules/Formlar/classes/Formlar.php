...
class Formlar {
    ...
    public static function updateCheck() {
        ...
        foreach ($enabled_modules as $enabled_item) {
            if ($enabled_item->getName() == 'Formlar') {
                $module = $enabled_item;
                break;
            }
        }
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://api.partydragen.com/stats.php?uid=' . $uid . '&version=' . $current_version . '&module=Formlar&module_version='.$module->getVersion() . '&domain='. Util::getSelfURL());
