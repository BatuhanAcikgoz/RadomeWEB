...
class SubmissionUpdatedStaffEvent extends AbstractEvent implements HasWebhookParams, DiscordDispatchable {
    ...
    public function __construct(User $user, Submission $submission, string $content, bool $anonymous, bool $staff_only, ?array $available_hooks) {        $this->user = $user;
    ...
    public static function description(): string {
        return (new Language(ROOT_PATH . '/modules/Formlar/language'))->get('forms', 'new_form_submission_comment_staff');
    }
