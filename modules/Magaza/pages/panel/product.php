...
if (!isset($_GET['action'])) {
    ...
    foreach (ActionsHandler::getInstance()->getActions($product) as $action) {
        ...
        $actions_array[] = [
            ...
            'edit_link' => URL::build('/panel/magaza/eylemler/', 'action=edit&product=' . $product->data()->id . '&aid=' . $action->data()->id),
            'delete_link' => URL::build('/panel/magaza/eylemler/', 'action=delete&product=' . $product->data()->id . '&aid=' . $action->data()->id),
            'warning' => $warning,
    ...
    $smarty->assign([
        ...
        'NEW_ACTION_LINK' => URL::build('/panel/magaza/eylemler/' , 'action=new&product=' . $product->data()->id),
