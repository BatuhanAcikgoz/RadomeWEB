 ...
 *  License: MIT
 *
 *  Magaza module - panel store page
 */
...
if (isset($_POST) && !empty($_POST)) {
    ...
    if (Token::check(Input::get('token'))) {
        ...
        if ($validation->passed()) {
            ...
            Settings::set('currency', $currency, 'Magaza');
            ...
            Settings::set('username_validation_method', Input::get('validation_method'), 'Magaza');
            Settings::set('discord_message', Input::get('discord_message'), 'Magaza');
...
$smarty->assign([
    ...
    'DISCORD_MESSAGE_VALUE' => Settings::get('discord_message', 'New payment from {username} who bought the following products {products}', 'Magaza'),
    ...
    'VALIDATION_METHOD_VALUE' => Settings::get('username_validation_method', 'radome', 'Magaza'),
]);
...
$template->addJSScript(Input::createTinyEditor($language, 'inputMagazaContent', null, false, true));
