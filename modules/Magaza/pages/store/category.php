...
// Get products
$products = DB::getInstance()->query('SELECT * FROM rw_store_products WHERE category_id = ? AND disabled = 0 AND hidden = 0 AND deleted = 0 ORDER BY `order` ASC', [$category_id]);
