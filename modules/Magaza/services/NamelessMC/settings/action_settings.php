...
$smarty->assign([
    ...
    'SETTINGS_TEMPLATE' => ROOT_PATH . '/modules/Magaza/services/RadomeWEB/settings/action_settings.tpl'
]);
...
if (Util::isModuleEnabled('Trophies')) {
    ...
    $trophies = DB::getInstance()->query('SELECT id, title FROM rw_trophies');
