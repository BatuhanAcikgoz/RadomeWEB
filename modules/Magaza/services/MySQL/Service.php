...
class MySQLService extends ServiceBase {
    public function __construct() {
        ...
        $connection_settings = ROOT_PATH . '/modules/Magaza/services/MySQL/settings/connection_settings.php';
        $action_settings = ROOT_PATH . '/modules/Magaza/services/MySQL/settings/action_settings.php';
