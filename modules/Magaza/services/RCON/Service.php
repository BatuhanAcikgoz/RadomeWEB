<?php
require_once ROOT_PATH . '/modules/Magaza/services/RCON/SourceQuery/bootstrap.php';
...
class RCONService extends ServiceBase implements ConnectionsBase {
    public function __construct() {
        ...
        $connection_settings = ROOT_PATH . '/modules/Magaza/services/RCON/settings/connection_settings.php';
        $action_settings = ROOT_PATH . '/modules/Magaza/services/RCON/settings/action_settings.php';
