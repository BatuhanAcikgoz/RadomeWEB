...
class PaymentCompletedEvent extends AbstractEvent implements HasWebhookParams, DiscordDispatchable {
    ...
    public static function description(): string {
        return (new Language(ROOT_PATH . '/modules/Magaza/language'))->get('admin', 'payment_completed');
    }
    ...
    public function webhookParams(): array {
        ...
        return [
            ...
            'amount' => Magaza::fromCents($this->payment->data()->amount_cents ?? 0),
            'amount_cents' => $this->payment->data()->amount_cents ?? 0,
            'currency' => $this->payment->data()->currency,
            'fee' => Magaza::fromCents($this->payment->data()->fee_cents ?? 0),
    ...
    public function toDiscordWebhook(): DiscordWebhookBuilder {
        ...
        $placeholders['{amount}'] = Magaza::fromCents($this->payment->data()->amount_cents);
        ...
        $discord_message = Settings::get('discord_message', 'New payment from {username} who bought the following products {products}', 'Magaza');
