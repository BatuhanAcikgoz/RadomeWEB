<?php
class PaymentRefundedEvent extends AbstractEvent implements HasWebhookParams, DiscordDispatchable {
    ...
    public static function description(): string {
        return (new Language(ROOT_PATH . '/modules/Magaza/language'))->get('admin', 'payment_refunded');
    }
    ...
    public function toDiscordWebhook(): DiscordWebhookBuilder {
        ...
        return DiscordWebhookBuilder::make()
            ...
            ->addEmbed(function (DiscordEmbed $embed) use ($store_language, $username) {
                return $embed
                    ->setDescription($store_language->get('general', 'refunded_payment_text', ['user' => $username]));
            });
    }
}