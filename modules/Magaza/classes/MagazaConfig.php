...
class MagazaConfig {
    ...
    public static function get($path = null) {
        if ($path) {
            if (!isset($GLOBALS['store_config'])) {
                throw new Exception('Magaza config unavailable');
            }
    ...
    public static function set($settings) {
        if (!file_exists(ROOT_PATH . '/modules/Magaza/config.php')) {
            fopen(ROOT_PATH . '/modules/Magaza/config.php', 'w');
        }

        require(ROOT_PATH . '/modules/Magaza/config.php');

        $loadedConfig = json_decode(file_get_contents(ROOT_PATH . '/modules/Magaza/config.php'), true);
    ...
    public static function write($config) {
        $file = fopen(ROOT_PATH . '/modules/Magaza/config.php', 'wa+');
