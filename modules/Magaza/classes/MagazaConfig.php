<?php
/**
 * Provides static methods to get and set configuration values from the `modules/Magaza/config.php` file.
 *
...
class MagazaConfig {
    ...
    /**
     * @return bool Whether `modules/Magaza/config.php` file exists and is writable.
     */
    public static function writeable(): bool {
        clearstatcache();
        return is_writable(ROOT_PATH . '/modules/Magaza/config.php');
    }
    ...
    public static function exists(): bool {
        return file_exists(ROOT_PATH . '/modules/Magaza/config.php');
    }

    /**
     * Read `modules/Magaza/config.php` file and load into cache
     *
    ...
    public static function all(): array {
        ...
        $config = require(ROOT_PATH . '/modules/Magaza/config.php');
        if ($config === 1) {
    ...
    /**
     * Overwrite new `modules/Magaza/config.php` file.
     *
    ...
    public static function write(array $config): void {
        ...
        if (file_put_contents(ROOT_PATH . '/modules/Magaza/config.php', $contents) === false) {
            throw new RuntimeException('Failed to write to config file');
        }
        if (function_exists('opcache_invalidate')) {
            opcache_invalidate(ROOT_PATH . '/modules/Magaza/config.php', true);
        }
        self::$_config_cache = $config;
    }

    /**
     * Get a config value from `modules/Magaza/config.php` file.
     *
    ...
    /**
     * Write a value to `modules/Magaza/config.php` file.
     *
    ...
    /**
     * Write multiple values to `modules/Magaza/config.php` file.
     *
