...
class Subscription {
    ...
    /**
     * @var SubscriptionData|null The subscription's data. Basically just the row from `rw_store_subscription` where the user ID is the key.
     */
