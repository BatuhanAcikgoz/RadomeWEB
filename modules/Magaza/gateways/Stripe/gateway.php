...
class Stripe_Gateway extends GatewayBase {
    ...
    public function processOrder(Order $order): void {
        ...
        $successRedirect = rtrim(Util::getSelfURL(), '/') . URL::build('/magaza/islem/', 'gateway=Stripe&do=success');
        $cancelRedirect = rtrim(Util::getSelfURL(), '/') . URL::build('/magaza/islem/', 'gateway=Stripe&do=cancel');
            ...
            try {
                ...
                if (!$hook_key) {
                    ...
                    $webhook = $stripe->webhookEndpoints->create([
                        'url' => rtrim(Util::getSelfURL(), '/') . URL::build('/magaza/listener', 'gateway=Stripe'),
