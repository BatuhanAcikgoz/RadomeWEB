<form action="" method="post">
    <div class="card shadow border-left-primary">
        <div class="card-body">
            ...
            - You can manage users credits from StaffCP -> User Management -> Users -> Find your User -> Magaza.</br>
            ...
            - Other RadomeWEB modules such as <a href="https://partydragen.com/resources/resource/13/" target="_blank">Trophies</a> and <a href="https://partydragen.com/resources/resource/11" target="_blank">Referrals</a> module have ability to reward users with credits.
        </div>
    </div>
