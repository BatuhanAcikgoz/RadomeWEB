 ...
 *  License: MIT
 *
 *  Magaza module - panel payments page
 */
...
class Magaza_Module extends Module {
    ...
    public function onPageLoad($user, $pages, $cache, $smarty, $navs, $widgets, $template) {
		...
		// Widgets
		// Latest purchases
		require_once(ROOT_PATH . '/modules/Magaza/widgets/LatestPurchasesWidget.php');
		$widgets->add(new LatestMagazaPurchasesWidget($smarty, $this->_language, $this->_store_language, $cache));

        if (defined('BACK_END')) {
            // Define permissions which belong to this module
            PermissionHandler::registerPermissions('Magaza', [
            ...
            if ($page['module'] == 'Magaza') {
                ...
                if (!isset($update_check->error) && !isset($update_check->no_update) && isset($update_check->new_version)) {  
                    $smarty->assign([
                        ...
                        'RADOME_UPDATE' => $this->_store_language->get('admin', 'view_resource'),
