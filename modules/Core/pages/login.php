...
$smarty->assign([
    ...
    'FORGOT_PASSWORD_URL' => URL::build('/sifremi_unuttum'),
    'FORGOT_PASSWORD' => $language->get('user', 'forgot_password2'),
    'FORGOT_EMAIL_URL' => URL::build('/mailimi_unuttum'),
    'FORGOT_EMAIL' => $language->get('user', 'forgot_email2'),
    'FORM_TOKEN' => Token::get(),
    'SIGN_IN' => $language->get('general', 'sign_in'),
    'REGISTER_URL' => URL::build('/kayit'),
