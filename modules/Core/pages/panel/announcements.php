...
if (!isset($_GET['action'])) {
    ...
    $smarty->assign([
        ...
        'NEW_LINK' => URL::build('/panel/duyurular', 'action=new'),
        'NEW' => $language->get('admin', 'new_announcement'),
        'ACTIONS' => $language->get('general', 'actions'),
        'EDIT_LINK' => URL::build('/panel/duyurular', 'action=edit&id='),
        'DELETE_LINK' => URL::build('/panel/duyurular', 'action=delete'),
        'REORDER_DRAG_URL' => URL::build('/panel/duyurular')
    ]);
            ...
            if (Input::exists()) {
                ...
                if (Token::check()) {
                    ...
                    if ($validation->passed()) {
                        ...
                        Redirect::to(URL::build('/panel/duyurular'));
                    }
...
$smarty->assign([
    ...
    'BACK_LINK' => URL::build('/panel/duyurular'),
