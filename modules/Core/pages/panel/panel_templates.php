...
if (!isset($_GET['action'])) {
    ...
    $smarty->assign([
        ...
        'VIEW_ALL_TEMPLATES_LINK' => 'https://radome.web.tr/resources/kategori/2-radomeweb-v2-templates/',
        'VIEW_ALL_PANEL_TEMPLATES' => $language->get('admin', 'view_all_panel_templates'),
        'VIEW_ALL_PANEL_TEMPLATES_LINK' => 'https://radome.web.tr/resources/kategori/8-radomeweb-panel-templates/',
