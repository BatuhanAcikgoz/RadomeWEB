...
if (isset($_GET['action'])) {
    if ($_GET['action'] == 'reset_banner') {
        ...
        Redirect::to(URL::build('/panel/gorseller'));
    }
...
$smarty->assign([
    ...
    'RESET_LINK' => URL::build('/panel/gorseller/', 'action=reset_bg'),
    'RESET_BANNER' => $language->get('admin', 'reset_banner'),
    'RESET_BANNER_LINK' => URL::build('/panel/gorseller/', 'action=reset_banner'),
    'RESET_LOGO' => $language->get('admin', 'reset_logo'),
    'RESET_LOGO_LINK' => URL::build('/panel/gorseller/', 'action=reset_logo'),
    'RESET_FAVICON' => $language->get('admin', 'reset_favicon'),
    'RESET_FAVICON_LINK' => URL::build('/panel/gorseller/', 'action=reset_favicon'),
