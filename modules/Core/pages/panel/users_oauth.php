    ...
    if (Input::exists()) {
        if (Token::check(Input::get('token'))) {
            if (isset($_POST['provider_name'], $_POST['user_id'])) {
                ...
                RadomeOAuth::getInstance()->unlinkProviderForUser($_POST['user_id'], $_POST['provider_name']);
...
$user_oauth_providers = RadomeOAuth::getInstance()->getAllProvidersForUser($user_query->id);
