...
class CloneGroupForumHook {
    ...
    public static function execute(array $params = []): void {
        ...
        $permissions = DB::getInstance()->query('SELECT * FROM rw_forums_permissions WHERE group_id = ?', [$params['cloned_group_id']]);
        if ($permissions->count()) {
            ...
            $query = 'INSERT INTO rw_forums_permissions (group_id, forum_id, view, create_topic, edit_topic, create_post, view_other_topics, moderate) VALUES ';
