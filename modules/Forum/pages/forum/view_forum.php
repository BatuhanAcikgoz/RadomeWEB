        ...
        foreach ($subforums as $subforum) {
            ...
            if ($forum->forumExist($subforum->id, $user_groups)) {
                if ($forum->canViewOtherTopics($subforum->id, $user_groups)) {
                    ...
                    $latest_post = DB::getInstance()->query('SELECT * FROM rw_topics WHERE forum_id = ? AND deleted = 0 AND topic_creator = ? ORDER BY topic_reply_date DESC', [$subforum->id, $user_id])->results();
                }
