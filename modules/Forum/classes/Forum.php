                ...
                $forums = $this->_db->query(
                    <<<SQL
                        ...
                        WHERE f.parent = ?
                          AND f.id IN 
                              (SELECT fp.forum_id
                               FROM rw_forums_permissions AS fp
