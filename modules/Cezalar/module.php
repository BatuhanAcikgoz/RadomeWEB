 ...
 *  License: MIT
 *
 *  Cezalar module info file
 */

class Cezalar_Module extends Module {
	...
	public function __construct($language, $infractions_language, $pages){
		...
		$pages->add('Cezalar', '/panel/cezalar', 'pages/panel/index.php');
		$pages->add('Cezalar', '/cezalar', 'pages/infractions.php');
	}
	...
	public function onPageLoad($user, $pages, $cache, $smarty, $navs, $widgets, $template){
		// Permissions
		PermissionHandler::registerPermissions('Cezalar', array(
