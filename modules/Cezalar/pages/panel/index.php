...
if(Input::exists()){
	...
	if(Token::check(Input::get('token'))){
		...
		// Update config
		$config_path = ROOT_PATH . DIRECTORY_SEPARATOR . 'modules' . DIRECTORY_SEPARATOR . 'Cezalar' . DIRECTORY_SEPARATOR . 'config.php';
		if(file_exists($config_path)){
			...
			// Create one now
			if(is_writable(ROOT_PATH . DIRECTORY_SEPARATOR . 'modules' . DIRECTORY_SEPARATOR . 'Cezalar')){
				// Build new email config
				$config = '<?php' . PHP_EOL .
					'$inf_db = array(' . PHP_EOL .
...
if(!isset($inf_db) && file_exists(ROOT_PATH . '/modules/Cezalar/config.php')){
	require_once(ROOT_PATH . '/modules/Cezalar/config.php');
}
