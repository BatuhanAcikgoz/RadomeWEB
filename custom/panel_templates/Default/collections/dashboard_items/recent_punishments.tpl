                        ...
                        <div class="card-header" style="border-radius: 10px" id="heading{$i}}">
                            <h5 class="mb-0">
                                <button class="btn btn-link btn-block btn-accordion" data-toggle="collapse" data-target="#collapse{$i}" aria-expanded="true" aria-controls="collapse{$i}">
                                    <span style="{$punishment.punished_style}"><img src="{$punishment.punished_avatar}" style="max-width:20px;max-height:20px;" class="rounded" alt="{$punishment.punished_username}" /> {$punishment.punished_username}</span>
                            ...
                            <div id="collapse{$i}" class="collapse text-center" aria-labelledby="heading{$i}" data-parent="#accordion">
                                ...
                                {$STAFF} <span style="{$punishment.staff_style}">{$punishment.staff_username} <img src="{$punishment.staff_avatar}" style="max-width:20px;max-height:20px;" class="rounded" alt="{$punishment.staff_username}" /></span><br />
