<form action="" method="post">
    ...
    <div class="form-group custom-control custom-switch">
        <input id="inputShowNickname" name="username" type="checkbox" class="custom-control-input js-check-change" value="1" {if $SHOW_USERNAME_INSTEAD_VALUE eq 1} checked{/if} />
        <label for="inputShowNickname" class="custom-control-label">
            {$SHOW_USERNAME_INSTEAD}
        </label>
    </div>
    <div type="form-group">
