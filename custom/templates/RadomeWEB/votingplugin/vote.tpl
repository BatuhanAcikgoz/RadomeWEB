            ...
            <div class="card">
                <div class="card-header header-theme">{$TOP_VOTERS}
                    <div class="float-right">
                        <div class="dropdown">
                            <button class="btn btn-theme btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{$ORDER}</button>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {foreach from=$VOTE_SITES_LIST item=site}
                        <a class="btn btn-lg btn-block btn-theme mb-1 text-truncate" href="{$site.site}" target="_blank" rel="noopener nofollow" role="button">{$site.name}</a>
                    {/foreach}
                </div>
            </div>
        </div>
