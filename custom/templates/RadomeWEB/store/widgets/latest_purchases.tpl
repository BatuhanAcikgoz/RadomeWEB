                ...
                <div class="card-body">
                    <div class="item">
                        ...
                        <img class="avatar" src="{$purchase.avatar}" alt="{$purchase.username}" width="48" height="48">
                            <a class="" {if $purchase.user_id}href="{$purchase.profile}" data-poload="{$USER_INFO_URL}{$purchase.user_id}"{/if} style="{$purchase.style|replace:';':''}!important;margin:5px">{$purchase.username}</a>
