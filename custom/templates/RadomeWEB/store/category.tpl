                  ...
                  <div class="modal-content">
                    {if $product.image}
                      <div class="ui small image">
                        <img class="server" src="{if $product.image == null}https://devs.radome.web.tr/uploads/favicons/block-min.png{/if}{$product.image}" alt="{$product.name}" style="width: 500px;">
                      </div>
                    {/if}
