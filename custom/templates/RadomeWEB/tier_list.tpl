                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{$data->profile_url}" style="color:  #035e9b;" data-poload="{$USER_INFO_URL}{$data->user_id}"  data-html="true" data-placement="top">{$data->username}</a>
                                        </td>
                                    </tr>
                                    {/if}
                                    {/foreach}
                                    {foreach from=$TIER_LIST_LT1_DATA item=data}
                                        ...
                                        <tr>
                                            <td>
                                                <img class="avatar-img" style="height: 30px; width: 30px;"
                                                    src="{$data->avatar}" alt="{$data->username}">
                                                <a href="{$data->profile_url}" style="color:  #5dade2 ;" data-poload="{$USER_INFO_URL}{$data->user_id}" data-html="true" data-placement="top">{$data->username}</a>
                                            </td>
                                        </tr>
                                        {/if}
                                        {/foreach}
